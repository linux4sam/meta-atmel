Contributors must sign off on each commit by adding a "Signed-off-by" line
...
For example, for contributions to the meta-mchp-distro layer:

[meta-mchp-distro] Description of the contribution
