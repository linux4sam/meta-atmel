FILESEXTRAPATHS_prepend_sam9x60 := "${THISDIR}/${PN}:"

SRC_URI_append_sam9x60 = "file://0001-cairo-path-fixed-fix-possible-buffer-overflow.patch \
...
PACKAGECONFIG_append_sam9x60 = " gfx2d"
