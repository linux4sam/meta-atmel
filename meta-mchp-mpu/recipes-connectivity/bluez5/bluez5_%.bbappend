...
do_install:append() {
    ...
    install -m 644 ${B}/src/.libs/libshared-glib.a ${D}/${libdir}/bluez5_utils/lib
    ...
    install -m 644  ${S}/gdbus/*.h ${D}${includedir}/bluez5_utils/gdbus/
    install -m 644  ${S}/lib/*.h ${D}${includedir}/bluez5_utils/bluetooth
