...
#	file://aiccu/unix-console/oe-makefile 
...
DEPENDS__${PN} += "awk eglibc gnutls"
#RDEPENDS__${PN} += "glibc gnutls"
RDEPENDS__${PN} += "eglibc gnutls"
RRECOMMENDS_${PN} = "ntp"
...
do_compile () {
#	RPM_OPT_FLAGS="0" CC="${CC}" oe_runmake -C unix-console
